...
export { default as ListaClientes } from "./lista/clientes/ListaClientes";
export { default as ListaProveedores } from "./lista/proveedores/ListaProveedores";
...
export {default as ListaStock} from './lista/stock/ListaStock'
